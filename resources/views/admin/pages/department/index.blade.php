    ...
    <tbody>
        @foreach ($departments as $sn => $item)
            <tr>
                ...
                <td>
                    <button class="btn btn-outline-secondary" type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editmodal<?php echo $item->uuid ?>"><i class="icofont icofont-edit"> Edit</i></button>
                    ...
                    <!-- Danger Header Modal -->
                    <button  type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#danger-header-modal<?php echo $item->uuid ?>"><i class="icofont icofont-trash"> Delete</i></button>
